...
wordListTwo[rand2] + " " + wordListThree[rand3];
 ...
 System.out.println("What we need is a " + oneLength);
 System.out.println("What we need is a " + twoLength);
 System.out.println("What we need is a " + threeLength);
 System.out.println("What we need is a " + rand1);
 System.out.println("What we need is a " + rand2);
 System.out.println("What we need is a " + rand3);
